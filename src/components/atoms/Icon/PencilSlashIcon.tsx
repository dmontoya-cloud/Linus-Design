export interface PencilSlashIconProps {
  className?: string
}

/**
 * Icon/PencilSlash — Phosphor "regular" weight (phosphor-icons/core, MIT-licensed), real SVG
 ...
 * `viewBox="0 0 256 256"`, `fill="currentColor"`. Leads the "Please do not write anything
 * down" instruction on Memory & Thinking's details screen.
 */
export function PencilSlashIcon({ className }: PencilSlashIconProps) {
  return (
