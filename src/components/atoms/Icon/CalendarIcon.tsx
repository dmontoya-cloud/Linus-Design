...
/**
 * Icon/Calendar — Phosphor "regular" weight (phosphor-icons/core, MIT-licensed), real SVG
 ...
 * `viewBox="0 0 256 256"`, `fill="currentColor"`. Leads the "once every three months"
 * caution on Memory & Thinking's details screen — replaces an earlier warning-triangle
 * icon, on request, since a calendar reads more clearly as a scheduling/frequency cue.
 */
