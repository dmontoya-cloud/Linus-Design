export interface ListNumbersIconProps {
  className?: string
}

/**
 * Icon/ListNumbers — Phosphor "regular" weight (phosphor-icons/core, MIT-licensed), real
 ...
 * `viewBox="0 0 256 256"`, `fill="currentColor"`. Leads the "Priorities" column in
 * Dashboard's full-check-in progress row.
 */
export function ListNumbersIcon({ className }: ListNumbersIconProps) {
  return (
