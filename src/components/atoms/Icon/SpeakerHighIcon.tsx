export interface SpeakerHighIconProps {
  className?: string
}

/**
 * Icon/SpeakerHigh — Phosphor "regular" weight (phosphor-icons/core, MIT-licensed), real SVG
 ...
 * `viewBox="0 0 256 256"`, `fill="currentColor"`. Leads the "Turn up your volume or use
 * headphones" instruction on Memory & Thinking's details screen.
 */
export function SpeakerHighIcon({ className }: SpeakerHighIconProps) {
  return (
